...
import org.dieschnittstelle.jee.esa.entities.crm.TouchpointCRUDWebService;
import org.dieschnittstelle.jee.esa.entities.crm.TouchpointCRUDWebServiceSOAP;
...
public class ShowTouchpointSOAPService {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 */
			serviceOperations.updateTouchpoint(tp.getId(), tp);

...
public class AccessRESTServiceWithInterpreter {
    ...
    public static void main(String[] args) {
        ...
        ITouchpointCRUDService serviceClient = (ITouchpointCRUDService) Proxy.newProxyInstance(AccessRESTServiceWithInterpreter.class.getClassLoader(),
                new Class[]{ITouchpointCRUDService.class}, invocationHandler);
